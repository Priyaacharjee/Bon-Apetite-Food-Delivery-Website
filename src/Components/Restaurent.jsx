...
const Restaurent = () => {
    ...
    function handleClick() {
        ...
        setc(false)
        const updateItem = Food_array.filter((currEle) => {
            return currEle.res.toLowerCase() === res.toLowerCase()
        })
        setData(updateItem)
        setcopy(updateItem)
    }
    ...
    const [text] = useTypewriter({
        words: ['Arsalan', 'Aminia', 'Meadow Cafe', 'Flurys', 'Flavour', 'Koshe Kosha', 'Oudh 1590', 'The Blue Mug', 'Spice Craft', 'Kusum Rolls',],
        loop: {},
    });
        ...
        <div className="container-fluid m-0 p-0" style={{ width: '100%' }}>
            <div className='row'>
                ...
                <div className='col-12 m-0 p-0'>
                    ...
                    <div className='col-12 Menu_background' style={{ display: 'flex' }}>
                        ...
                        <div className='search-bar-container col-xl-5 col-lg-4 col-md-5 col-sm-7 col-7'>
                            ...
                            <div className="input-wrapper div">
                                ...
                                <input placeholder="Search Restaurent..." id='item' className="Search_input" ref={textInput} />
                            </div>
                            <div className='mt-4'>
                    ...
                    {/* <Restaurentcategory/> */}
                    <h4 className="text-center pt-2">Restaurent Names</h4><hr></hr>

                    <div className="row m-0" style={{ padding: '10px 0px 20px 0px', justifyContent: 'center' }}>
                        {
                            Restaurent_list_array.map((elem) => {
                                const { name } = elem;
                                return (
                                    <>
                                    {/* <Link to="section" spy={true} smooth={true} duration={500}> */}
                                        <div className="mt-0 float-left pb-0" style={{ height: '50%', width: '12%' }}>
                                        {/* <Link to="section" spy={true} smooth={true} duration={500}> */}
                                            <button className='flex flex-col justify-center items-center m-0 ml-2 mr-2 mt-2 mb-2 p-0' style={{ height: '20%', borderRadius: '10px', borderStyle: 'solid', borderColor: '#16A085', boxShadow: 'rgb(204, 219, 232) 3px 3px 6px 0px inset, rgba(255, 255, 255, 0.5) -3px -3px 6px 1px inset', height: '5%', width: '90%', backgroundColor: 'white' }}>
